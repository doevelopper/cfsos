...
function create_disk_image() {
  ...
  local genimage_cfg="${BR2_EXTERNAL_CFSOS_PATH}/board/common/genimage.cfg"
...
function create_rauc_bundle() {
    ...
    rauc bundle \
	    --cert "${BR2_EXTERNAL_CFSOS_PATH}/board/certs/rauc/cert.pem" \
	    --key "${BR2_EXTERNAL_CFSOS_PATH}/board/certs/rauc/key.pem" \

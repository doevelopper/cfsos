#
# Copyright (c) 2022-2025, ACME AHL Limited and Contributors. All rights reserved.
#
...
include ${MAKE_HELPERS_DIRECTORY}rauc.mk
include ${MAKE_HELPERS_DIRECTORY}versioning.mk
include ${MAKE_HELPERS_DIRECTORY}web-self-certs.mk
...
#rsync -av --progress --delete --exclude='*.cpio' $(BLRT_OOSB)/$*-build-artifacts/images/ srv:/srv/netboot/rpi/

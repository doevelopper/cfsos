...
$(TARGETS_CONFIG_COMPILE): %-compile: 
...
# $(REAL_CLEAN_PKG): %-realclean:
# 	$(Q)$(call MESSAGE,"[ Wiping everything in $(BLRT_OOSB) ]")
# #	$(Q)rm -fr workspace
...
help: ## Display this help and exits.
	...
	$(call print-help,$(MAKE) $(addsuffix -distclean,$(TARGET_BOARD)),Distclean $(TARGET_BOARD))
	$(Q)echo
